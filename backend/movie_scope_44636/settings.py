"""
Django settings for movie_scope_44636 project.
...
ROOT_URLCONF = 'movie_scope_44636.urls'
...
WSGI_APPLICATION = 'movie_scope_44636.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "movie_scope_44636 API",
    "DESCRIPTION": "API documentation for movie_scope_44636 App",
    "VERSION": "v1",
}
